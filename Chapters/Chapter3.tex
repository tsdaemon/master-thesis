...
When the model learned the probability model on train examples, it can generate new translations. This can be done in several ways \parencite{Neubig2017}:
        \begin{itemize}
